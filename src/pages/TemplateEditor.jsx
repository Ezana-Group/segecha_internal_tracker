...
const PLACEHOLDER_GROUPS = [
    {
        ...
        items: [
            ...
            { key: "companyRegistrationNumber", desc: "Company registration number" },
            { key: "companyRegNo", desc: "Short alias for registration number" },
            ...
            { key: "paybillNumber", desc: "M-Pesa Paybill number" },
            { key: "paybillAccount", desc: "M-Pesa account/reference format" },
            { key: "mpesaTillNumber", desc: "M-Pesa Till number (if used)" },
            { key: "mpesaPhone", desc: "Fallback M-Pesa phone number" },
            { key: "bankName", desc: "Bank name for transfers" },
            { key: "bankAccount", desc: "Bank account number" },
            { key: "bankBranch", desc: "Bank branch name" },
            { key: "bankSwift", desc: "SWIFT / BIC code" },
            { key: "bankIban", desc: "IBAN (if available)" },
            { key: "paypalEmail", desc: "PayPal receiving email" },
            { key: "paypalLink", desc: "PayPal payment link" },
            { key: "pesapalLink", desc: "Pesapal checkout link" },
            { key: "pesapalMerchantCode", desc: "Pesapal merchant code/reference" },
            { key: "manualPaymentInstructions", desc: "Extra payment instructions text" },
        ],
    },
    {
    ...
    },
    {
        ...
        items: [
            ...
            { key: "depositAmount", desc: "Journey deposit amount (if any)" },
            { key: "finalPaymentAmount", desc: "Final payment amount (if any)" },
...
function buildSampleContext(companyName = "Segecha Group Ltd") {
    return expandMessageTemplateContext({
        ...
        amount: "KES 125,000",
        amountDue: "KES 35,000",
        dueDate: "2026-04-15",
        depositAmount: "KES 25,000",
        finalPaymentAmount: "KES 100,000",
        mpesaRef: "QJK1234567",
        journeyId: "J026",
        origin: "Nairobi",
        destination: "Mombasa",
        ...
        supportEmail: "ops@segecha.co.ke",
        supportPhone: "+254700111222",
        companyRegistrationNumber: "CPR/2019/123456",
        companyRegNo: "CPR/2019/123456",
        loyaltyPoints: "1,250",
    });
}
