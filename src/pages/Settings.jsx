        ...
        () => [
            {
                ...
                icon: Briefcase,
                color: "#3b82f6",
                items: ["businessName", "company_name", "today", "footer", "baseUrl", "site"],
            },
            {
                ...
                icon: Key,
                color: "#8b5cf6",
                items: ["verifyUrl", "resetUrl", "loginEmail", "otp"],
            },
            {
                cat: "CUSTOMER",
                filterCat: "Customer",
                icon: Users,
                color: "#10b981",
                items: ["firstName", "customerName", "customerEmail", "customerPhone", "loyaltyPoints"],
            },
            {
                cat: "INVOICES",
                filterCat: "Invoices",
                icon: FileText,
                color: "#f97316",
                items: ["invoiceId", "amount", "dueDate", "mpesaRef", "customerPhone"],
            },
            {
                ...
                icon: Navigation,
                color: "#6366f1",
                items: ["journeyId", "origin", "destination", "dest", "cargo", "truckReg", "driverName", "revenue", "waybillNo", "borderPoint"],
            },
            {
                cat: "STAFF & DRIVERS",
                ...
                icon: IdCard,
                color: "#ec4899",
                items: ["staffName", "staffId", "driverName", "driverId"],
            },
        ],
        []
    );
