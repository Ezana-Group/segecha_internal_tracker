...
export function expandMessageTemplateContext(ctx = {}) {
    ...
    mirror("paybillNumber", "paybill_number");
    mirror("paybillAccount", "paybill_account");
    mirror("mpesaTillNumber", "mpesa_till_number");
    mirror("mpesaPhone", "mpesa_phone");
    mirror("bankName", "bank_name");
    mirror("bankAccount", "bank_account");
    mirror("bankBranch", "bank_branch");
    mirror("bankSwift", "bank_swift");
    mirror("bankIban", "bank_iban");
    mirror("paypalEmail", "paypal_email");
    mirror("paypalLink", "paypal_link");
    mirror("pesapalLink", "pesapal_link");
    mirror("pesapalMerchantCode", "pesapal_merchant_code");
    mirror("manualPaymentInstructions", "manual_payment_instructions");
