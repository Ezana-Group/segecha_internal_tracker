...
export default function PaymentPortal() {
    ...
    const S = {
        page: { minHeight: '100vh', background: 'radial-gradient(at 0% 0%, rgba(232, 80, 26, 0.1) 0, transparent 50%), radial-gradient(at 100% 100%, rgba(27, 58, 107, 0.1) 0, transparent 50%), #ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '14px', fontFamily: "'Helvetica Neue', Arial, sans-serif" },
        card: { background: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(20px)', borderRadius: 20, padding: 28, width: '100%', maxWidth: 480, boxShadow: '0 20px 50px rgba(0,0,0,0.06)', border: '1px solid rgba(0,0,0,0.05)' },
        ...
        invBox: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 14, padding: '12px 16px', marginBottom: 16 },
        ...
        sectionTitle: { fontSize: 11, fontWeight: 700, color: '#9ca3af', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
        ...
        stepTitle: { fontSize: 19, fontWeight: 800, color: '#111827', marginBottom: 12 },
        ...
        infoBox: (bg, border) => ({ background: bg || '#f0fdf4', border: `1px solid ${border || '#bbf7d0'}`, borderRadius: 12, padding: 14, marginBottom: 12 }),
        infoRow: { fontSize: 14, color: '#374151', marginBottom: 7 },
        pending: { background: '#fffbeb', border: '1px solid #fde68a', borderRadius: 12, padding: 16, textAlign: 'center' },
        ...
        footer: { textAlign: 'center', marginTop: 16, paddingTop: 12, borderTop: '1px solid #f1f5f9', fontSize: 11, color: '#9ca3af', lineHeight: 1.7 },
    };
