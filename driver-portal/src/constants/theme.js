...
export const S = {
    ...
    card: (accent) => ({ background: COLORS.surface, borderRadius: 14, padding: 14, marginBottom: 10, border: `1px solid ${accent ? accent + '33' : COLORS.border}`, borderTop: accent ? `3px solid ${accent}` : undefined, boxShadow: '0 1px 4px rgba(0,0,0,.05)' }),
    sectionTitle: { fontSize: 11, fontWeight: 700, color: COLORS.textFaint, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8, marginTop: 2 },
